...
module ActiveStorage
  ...
  #
  # Bucket `czin` dùng chung cho nhiều app (loyalty, estate, boidat…), mà
  # ActiveStorage::Service::S3Service không có tuỳ chọn prefix: mọi app đổ khoá
  # ngẫu nhiên 28 ký tự thẳng vào gốc bucket. Không đụng nhau — khoá là ngẫu
  # nhiên — nhưng nhìn vào bucket thì không biết tệp nào của app nào. Không đặt
  # được lifecycle riêng, và quan trọng hơn: không chỉ ra được chính xác đâu là
  # ảnh khuôn mặt trẻ em của BƠI ĐẠT khi cần xoá theo yêu cầu (NĐ 13/2023).
  #
